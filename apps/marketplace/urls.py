...
urlpatterns = [
    ...
    path(
        "negotiations/buying/", views.my_negotiations_buyer, name="negotiations_buyer"
    ),
    path(
    ...
    path(
        ...
        views.accept_negotiation,
        name="accept_negotiation",
    ),
    path(
        "negotiation/<int:negotiation_id>/confirm/",
        views.confirm_negotiation,
        name="confirm_negotiation",
    ),
    path(
        "negotiation/<int:negotiation_id>/reject/",
        views.reject_negotiation,
        name="reject_negotiation",
    ),
    path(
        "negotiation/<int:negotiation_id>/open/",
        views.open_negotiation_conversation,
